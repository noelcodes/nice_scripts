# This script scans thru sgcarmart_by_generations 
# Then create folder year_model
...
path = "D:/xrvision/xrvision_dataset/sgcarmart_by_generations"
...
for subdirs, dirss, files in os.walk(path):
    for dirs in dirss:
        ...
        if not os.path.exists(new_gen_path):
            os.makedirs(new_gen_path)
